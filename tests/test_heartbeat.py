...
def test_thresholds_are_at_least_double_the_publishing_rate():
    ...
    Новости 3 поста за 9 ч, Кино 6 публикаций за 15 ч, Музыка 4 за 17 ч (окно
    расширено 2026-08-18 по ТЗ «растянуть на весь день»). Прежний счёт от суток занижал
    пороги и делал тревогу ежедневной."""
