...
# Каталоги временных медиа и срок жизни в часах.
#
# ТЗ владельца 2026-08-11: «чтобы они ничего не хранили и было авто удаление». Сроки
# ужаты до реального времени жизни файла в пайплайне, а не «на всякий случай»:
#   * исходники поста (`*_raw_media`, `raw`, `images`, `videos`) нужны от скачивания до
#     публикации — это часы, а не сутки. Отложенный постом с медиа пост ждёт свободного
#     токена, но интервал канала — максимум 8 часов, так что 12 покрывают и его;
#   * фильм публикуется сразу после скачивания, всё что старше — сирота от убитого
#     процесса (`finally` при SIGKILL не выполняется);
#   * клипы ждут своей очереди по плану, до суток — им 30 часов с запасом.
# Раньше здесь стояли 24/24/48, и на диске без всякой пользы лежал лишний суточный слой.
